...
//                	System.out.println("DEBUG: streamReader.getLocalName()=" + streamReader.getLocalName());
                    if (streamReader.getLocalName().equalsIgnoreCase("Sofa")) {
                    	System.out.println("DEBUG: streamReader.getLocalName()=" + streamReader.getLocalName());
                        analysisText = streamReader.getAttributeValue(4);
                    }
                    else {
                    	System.out.println("WARN: analysisText is null!");
                        System.out.println("DEBUG: streamReader.getLocation()=" + streamReader.getLocation());
                        streamReader.next();
                    	continue;
                    }
                }
                try {
                	System.out.println("DEBUG: analysisText=" + analysisText);
