...
//	               "resources/org/apache/ctakes/dictionary/lookup/fast/customDictionary.xml")
//	      );
	      builder.add( AnalysisEngineFactory.createEngineDescription( DefaultJCasTermAnnotator.class,
	               AbstractJCasTermAnnotator.PARAM_WINDOW_ANNOT_KEY,
	               "org.apache.ctakes.typesystem.type.textspan.Sentence",
		  ...
		  builder.add( AnalysisEngineFactory.createEngineDescription( DrugMentionAnnotator.class ) );
			...
			builder.add(BackwardsTimeAnnotator
					.createAnnotatorDescription("resources/org/apache/ctakes/temporal/ae/timeannotator/model.jar"));
			// Add EventAnnotator
			builder.add(EventAnnotator
					.createAnnotatorDescription("resources/org/apache/ctakes/temporal/ae/eventannotator/model.jar"));
			...
			builder.add(DocTimeRelAnnotator
   					.createAnnotatorDescription("resources/org/apache/ctakes/temporal/ae/doctimerel/model.jar"));
			// Add Event to Event Relation Annotator
			builder.add(EventTimeSelfRelationAnnotator
					.createEngineDescription("resources/org/apache/ctakes/temporal/ae/eventtime/20150629/model.jar"));
			// Add Event to Event Relation Annotator
			builder.add(EventEventRelationAnnotator
					.createAnnotatorDescription("resources/org/apache/ctakes/temporal/ae/eventevent/20150630/model.jar"));
